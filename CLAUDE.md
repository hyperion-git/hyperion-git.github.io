...
- **Impressum**: `_pages/impressum.md` (linked from the footer via `impressum_path`) still carries ⟨…⟩ placeholders for address and e-mail; the owner fills them before the site goes public.
